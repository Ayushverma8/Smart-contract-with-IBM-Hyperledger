...
class AssignmentTwoContract extends Contract {
    ...
    async readAssignmentTwo(ctx, assignmentTwoId) {
        const exists = await this.assignmentTwoExists(ctx, assignmentTwoId);
        if (!exists) {
            throw new Error(
    ...
    async updateAssignmentTwo(ctx, assignmentTwoId, newValue) {
        const exists = await this.assignmentTwoExists(ctx, assignmentTwoId);
        if (!exists) {
            throw new Error(
                `The assignment two ${assignmentTwoId} does not exist`
    ...
    async assignStatusOfContract(ctx, assignmentTwoId, newValue) {
        const exists = await this.assignmentTwoExists(ctx, assignmentTwoId);
        if (!exists) {
            throw new Error(
                `The assignment two ${assignmentTwoId} does not exist`
